...
import { CheckIcon, XIcon, StarIcon, HeartIcon, LightbulbIcon, VolumeIcon } from '@/components/icons/LucideReplacement';
...
export default function TranslationExercise({
  ...
  const handlePlayAudio = () => {
    ...
    console.debug('Playing audio for:', exercise.correctAnswer);
  };
        ...
        <Card style={[
          ...
          {!isCorrect && (
            <View style={styles.correctAnswerContainer}>
              <Text style={styles.correctAnswerLabel}>Correct translation:</Text>
      ...
      <Card style={styles.exerciseCard}>
        ...
        <View style={styles.translationContainer}>
          <View style={styles.sourceTextContainer}>
            <Text style={styles.sourceTextLabel}>Translate this:</Text>
            <View style={styles.sourceText}>
              <Text style={styles.sourceTextContent}>
                {getContentInLanguage(exercise.question, 'es')}
              </Text>
              <TouchableOpacity
          ...
          <View style={styles.targetTextContainer}>
            <Text style={styles.targetTextLabel}>Your translation:</Text>
            <Animated.View
              style={[

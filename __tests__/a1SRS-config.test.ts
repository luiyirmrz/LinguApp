...
/**
 * A1 SRS Configuration Test Suite
...
export const mockCroatianA1Vocabulary = [
  {
    id: 'hr_a1_001',
    word: 'zdravo',
    translation: 'hello',
...
export const mockCroatianA1Grammar = [
  {
    id: 'hr_a1_gram_001',
...
describe('A1 Croatian Vocabulary Integration', () => {
  test('should have Croatian A1 vocabulary loaded', () => {
    expect(mockCroatianA1Vocabulary).toBeDefined();
    expect(mockCroatianA1Vocabulary.length).toBeGreaterThan(0);
  });

  test('should have Croatian A1 grammar loaded', () => {
    expect(mockCroatianA1Grammar).toBeDefined();
    expect(mockCroatianA1Grammar.length).toBeGreaterThan(0);
  });
...
describe('A1 SRS Integration', () => {
  ...
  test('should validate SRS configuration parameters', () => {
    ...
    expect(A1_SRS_CONFIG.MIN_EASE_FACTOR).toBeLessThan(A1_SRS_CONFIG.MAX_EASE_FACTOR);
    expect(A1_SRS_CONFIG.DEFAULT_EASE_FACTOR).toBeGreaterThanOrEqual(A1_SRS_CONFIG.MIN_EASE_FACTOR);
    expect(A1_SRS_CONFIG.DEFAULT_EASE_FACTOR).toBeLessThanOrEqual(A1_SRS_CONFIG.MAX_EASE_FACTOR);
    
    // Test interval progression
    expect(A1_SRS_CONFIG.INITIAL_INTERVAL).toBeGreaterThan(0);
    expect(A1_SRS_CONFIG.SECOND_INTERVAL).toBeGreaterThan(A1_SRS_CONFIG.INITIAL_INTERVAL);
    expect(A1_SRS_CONFIG.THIRD_INTERVAL).toBeGreaterThan(A1_SRS_CONFIG.SECOND_INTERVAL);
    
    // Test quality thresholds
    expect(A1_SRS_CONFIG.PASSING_QUALITY).toBeGreaterThanOrEqual(0);
    expect(A1_SRS_CONFIG.PASSING_QUALITY).toBeLessThanOrEqual(5);
    expect(A1_SRS_CONFIG.EXCELLENT_QUALITY).toBeGreaterThanOrEqual(A1_SRS_CONFIG.PASSING_QUALITY);
  });
});
